class Masker {
    ...
    _settleObject(destination, source, props, layer) {
        ...
        if (this._isNil(destination) && !this._isNil(source)) {
            return touched;
        }
    ...
    _settleValue(destination, source, prop, Type, layer) {
        ...
        const settled = {};
        if (this._isNil(destination[prop]) && this._isNil(source[prop])) {
            return settled;
        }
    ...
    _settleArrayValue(destination, source, prop, Type, layer) {
        ...
        if (destinationItems.length > length) {
            destinationItems.length = length;
        }
