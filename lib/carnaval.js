...
class CodecDecorator extends Codec {
    constructor(mapping, options, encoders, decoders, providers) {
...
class Carnaval {
    ...
    codec(mapping, options) {
        return new CodecDecorator(mapping, options, this.encodeMiddlewares, this.decodeMiddlewares, this.providersObject);
    }
}
